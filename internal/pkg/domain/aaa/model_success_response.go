...
func (o *SuccessResponse) GetError() Error {
...
func (o *SuccessResponse) GetErrorOk() (*Error, bool) {
	if o == nil || isNil(o.Error) {
    return nil, false
	}
	return o.Error, true
...
func (o *SuccessResponse) HasError() bool {
	if o != nil && !isNil(o.Error) {
		return true
	}
...
func (o *SuccessResponse) SetError(v Error) {
	o.Error = &v
}
