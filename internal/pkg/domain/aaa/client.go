...
// APIClient manages communication with the Authentication And Authorization (AAA) Service API v1.0.0
...
type APIClient struct {
	...
	AdminManagementApi *AdminManagementApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AdminManagementApi = (*AdminManagementApiService)(&c.common)
