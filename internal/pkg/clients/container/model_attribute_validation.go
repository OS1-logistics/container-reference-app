...
func (o *AttributeValidation) GetValueOneOf() []ValidationValueOneOfInner {
...
// and a boolean to check if the value has been set.
func (o *AttributeValidation) GetValueOneOfOk() ([]ValidationValueOneOfInner, bool) {
	if o == nil || o.ValueOneOf == nil {
		return nil, false
	}
...
func (o *AttributeValidation) SetValueOneOf(v []ValidationValueOneOfInner) {
	o.ValueOneOf = v
}
