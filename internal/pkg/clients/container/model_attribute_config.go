...
func (o *AttributeConfig) GetDefaultValue() ValidationValueOneOfInner {
...
// and a boolean to check if the value has been set.
func (o *AttributeConfig) GetDefaultValueOk() (*ValidationValueOneOfInner, bool) {
	if o == nil || o.DefaultValue == nil {
		return nil, false
	}
...
func (o *AttributeConfig) SetDefaultValue(v ValidationValueOneOfInner) {
	o.DefaultValue = &v
}
